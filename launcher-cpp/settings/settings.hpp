...
#include "../modules/module_description.hpp"
...
struct settings
{
    ...
    struct s_module
    {
        struct s_monitor : module_description
        {
            ...
            s_monitor(const s_monitor&) = default;
            s_monitor(s_monitor&&) = default;
            s_monitor& operator=(const s_monitor&) = default;
            s_monitor& operator=(s_monitor&&) = default;
        ...
        struct s_server : module_description
        {
            ...
            s_server& operator=(s_server&& oth) = default;
        ...
        struct s_router : module_description
        {
            struct s_source
            {
                ...
                {
                    return name == oth.name && frames_per_buffer == oth.frames_per_buffer && sample_rate == oth.sample_rate &&
                        channels == oth.channels;
                }
        ...
        struct s_snapserver : module_description
        {
            ...
            s_snapserver& operator=(s_snapserver&& oth) = default;
        ...
        struct s_snapclient : module_description
        {
            ...
            s_snapclient& operator=(s_snapclient&& oth) = default;
...
using module_params = std::variant<
...
inline const module_description& module_cast(const module_params& params)
{
