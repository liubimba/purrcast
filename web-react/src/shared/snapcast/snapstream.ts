/*
 * Derived from Snapweb (https://github.com/badaix/snapweb), the web interface for Snapcast.
 * Copyright (C) 2014-2025  Johannes Pohl
 * Modifications Copyright (C) 2025-2026  liubimba
 *
...
class TimeProvider {
    ...
    setDiff(c2s: number, s2c: number) {
        ...
        // //console.debug("c2s: " + c2s.toFixed(2) + ", s2c: " + s2c.toFixed(2) + ", diff: " + this.diff.toFixed(2) + ", now: " + this.now().toFixed(2) + ", connections.now: " + this.serverNow().toFixed(2) + ", win.now: " + window.performance.now().toFixed(2));
